...
export const projects: Project[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2RpbmclMjBkYXJrJTIwc2NyZWVufGVufDF8fHx8MTc3NTQxODEyMXww&ixlib=rb-4.1.0&q=80&w=1080',
    color: '#6EE7FF',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkYXJrJTIwbm90ZXN8ZW58MXx8fHwxNzc1NDE4MTIyfDA&ixlib=rb-4.1.0&q=80&w=1080',
    color: '#A78BFA',
    ...
    decisions: [
      ...
      'Implemented offline-first design — app functions even without connectivity',
      'Used Kotlin coroutines for non-blocking database operations',
    ],
    outcome: 'Gained practical experience in database integration and backend communication in Android. Built a functional data-driven mobile app ready for real users.',
  ...
  },
  {
    ...
    decisions: [
      ...
      'Implemented secure token storage using Android Keystore',
      'Built GitHub OAuth to understand third-party auth flows end-to-end',
    ],
    outcome: 'Successfully implemented a complete authentication flow with user dashboard. Significantly improved knowledge of secure login systems and user session handling.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjBwcm9kdWN0JTIwZGVzaWduJTIwbW9iaWxlfGVufDF8fHx8MTc3NTQxODEyMnww&ixlib=rb-4.1.0&q=80&w=1080',
    color: '#F59E0B',
    ...
    approach: 'Designed and developed a product detail UI using Kotlin, focusing on visual hierarchy, touch targets, and layout clarity. Iterated through multiple design states before coding.',
    decisions: [
      'Designed in Figma first — validated layout before writing a single line of Kotlin',
      'Used bottom sheets instead of separate screens to keep context',
      'Prioritized thumb-friendly tap zones for one-handed use',
    ],
    outcome: 'Created a modern, user-friendly product interface. Project is ongoing with strong focus on usability and layout scalability for a full catalog.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGglMjBhcHAlMjB1aSUyMGRlc2lnbiUyMHBlcnNvbmFsfGVufDF8fHx8MTc3NTQxODEyMnww&ixlib=rb-4.1.0&q=80&w=1080',
    color: '#F472B6',
    problem: 'Lack of personalized, accessible, and truly supportive menstrual health tracking solutions — most existing apps are clinical rather than human-centered.',
    approach: 'Led frontend development and UI/UX design using Figma for a menstrual tracking app with AI-generated insights and community features. Human-centered design process throughout.',
    decisions: [
      'Used Figma components to ensure design consistency across all screens',
      'Designed for accessibility — color contrast, readable fonts, clear hierarchy',
      'Community features designed for safety and moderation from day one',
    ],
    outcome: 'Delivered a user-centered design and contributed to a functional health-focused platform with personalized AI insights. Demonstrated ability to lead design on a sensitive, important product.',
